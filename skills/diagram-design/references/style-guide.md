...
|---|---|---|---|
| `paper` | Page background, default node fill | `#ffffff` (Material light surface) | `#12171b` (deep slate-teal) |
| `paper-2` | Diagram container bg, secondary fill | `#f6f8f8` | `#1b2227` |
| `ink` | Primary text, primary stroke | `#17313b` (deep teal-slate) | `#f4f7f8` |
| `muted` | Secondary text, default arrow stroke | `#4a6570` | `#a3bcc3` |
| `soft` | Sublabels, boundary labels | `#74898f` | `#7f99a1` |
| `rule` | Hairline borders | `rgba(23,49,59,0.12)` | `rgba(244,247,248,0.12)` |
| `rule-solid` | Stronger borders, baselines | `#b9c6ca` | `rgba(163,188,195,0.30)` |
| `accent` | Focal / 1–2 max per diagram | `#009485` (Material teal) | `#26b3a5` |
| `accent-tint` | Fill for accent-bordered boxes | `rgba(0,148,133,0.08)` | `rgba(38,179,165,0.12)` |
| `link` | HTTP/API calls, external arrows | `#4051b5` (Material indigo) | `#8290d8` |

> **Profile: mappview-docs** — skin extracted from the MappView documentation site (MkDocs Material, `primary: teal`, `accent: indigo`) and the repo `DESIGN.md` typography intent. Brand palette: `deep teal-slate #17313b`, `Material teal #009485`, `Material indigo #4051b5`. The `paper`, `muted`, `soft`, `rule`, and `rule-solid` values are derived from the site chrome (`docs/stylesheets/extra.css`) to cover the remaining roles.
