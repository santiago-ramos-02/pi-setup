...
The model files in [`profiles/santiago/pi-profiles/`](profiles/santiago/pi-profiles/README.md) use Gentle-Pi's profile export format. Import only the profiles you want into Pi's `/gentle:profiles` selector.
