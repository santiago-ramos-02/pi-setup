# OpenCode Free model profile

This Pi profile uses OpenCode's free Muse Spark 1.3 Contributor model for both the main session and Gentle-Pi delegated agents.

- Main model: `opencode/muse-spark-1.3-contributor-free`
...
- Provider access: OpenCode Free must be available and authenticated on the machine
