...
The license text is included at [`third-party/TABLER_LICENSE.txt`](third-party/TABLER_LICENSE.txt).
...
The CC0 dedication is included at [`third-party/SIMPLE_ICONS_LICENSE.md`](third-party/SIMPLE_ICONS_LICENSE.md).
...
The license text is included at [`third-party/LOG_Z_LICENSE.txt`](third-party/LOG_Z_LICENSE.txt).
...
The license text is included at [`third-party/DEVICON_LICENSE.txt`](third-party/DEVICON_LICENSE.txt).
